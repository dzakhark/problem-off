...
@Component({
  selector: 'app-category-list-dynamic',
  templateUrl: './category-list-dynamic.component.html',
  styleUrls: ['./category-list-dynamic.component.css']
})
export class CategoryListDynamicComponent implements OnInit {
